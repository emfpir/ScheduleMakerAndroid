...
//sets the selected schedule in schedule table to schedule fields    
    ...
    private boolean checkOpen(String start, String end) {
     ...
     private void invalidEntryCustomer(){
        ...
        alert.setContentText("The customer name can only contain alphabetic character. The address must start with numeric character and end with alpahbetic characters. The phone number must only have numeric characters and hyphen.");
        alert.showAndWait();   
    }
